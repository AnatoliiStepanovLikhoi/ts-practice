...
class Developer {
  public name: string; // модифікатор доступу public - вказує, що поле, видиме за межами даного класу
...
const dev: Developer = new Developer("Ivan", "Junior");
dev.name = "John";
